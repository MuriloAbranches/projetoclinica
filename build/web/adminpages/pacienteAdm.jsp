            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li class="active"><a href="pacienteAdm.jsp"><i class="fa fa-edit"></i> Pacientes</a></li>
                    ...
                    <div class="col-lg-6"> <!--12-->
                        ...
                        <form method="post" action="">
                            <div class="form-group">
                                ...
                                <label>DDD:
                                    <input name="dddtel" type="tel" id="dddtel" size="1" maxlength="2"  class="form-control" /></label> 
                                <label>Telefone:
                                    <input name="telefone" type="tel" id="telefone" size="17" maxlength="9"  class="form-control" /></label><br />
                                <label>DDD:
                                    <input name="dddcel" type="tel" id="dddcel" size="1" maxlength="2"  class="form-control" /></label> 
                                <label>Celular:
                                    <input name="celular" type="tel" id="celular" size="17" maxlength="9"  class="form-control" /></label> 
                                <label>Email:
